...
! function(e) {
	...
	var i = function(e) {
		...
		x = '<div class="file-thumbnail-footer">\n    <div class="file-caption-name" style="height:18px">{caption}</div>\n    {actions}\n</div>',
		//zander  不显示底部按钮
