(function(root, factory) {
    ...
    var Typeahead = function(element, options) {
        ...
        this.clearElement = this.options.clearElement;
        this.notMatcher = this.options.notMatcher;
    ...
    Typeahead.prototype = {
        ...
        listen: function() {
            ...
            this.$element.on('compositionstart',$.proxy(function(){
	            this.compositionFlag = false;
	        },this))
            this.$element.on('compositionend',$.proxy(function(){
	            this.compositionFlag = true;
	        },this))
        ...
        destroy: function() {
			...
			this.$element.off("compositionstart").off("compositionend");
            if (this.eventSupported("keydown")) {
