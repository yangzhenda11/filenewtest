    ...
    var methods = {
        ...
        initState: function() {
            ...
            if ($this.treegrid('getSetting', 'saveState') && !$this.treegrid('isFirstInit')) {
                ...
                */
                /** lisy 2017-11-24 delete end */
                
                /** lisy 2017-11-24 add start */
                if ($this.treegrid('getSetting', 'initialState') === "expanded") {
                    $this.treegrid('expand');
                } else if ($this.treegrid('getSetting', 'initialState') === "collapsed") {
                    $this.treegrid('collapse');
                }
                /** lisy 2017-11-24 add end */
            }
            return $this;
        },
        /**
