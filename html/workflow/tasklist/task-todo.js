...
function handleTaskToDo(id, taskDefinitionKey, name, processInstanceId, title,
		...
		var specialList = ["GDCL","GDQR","BMQR","GSQR","GZGZ","HTGD","KHQR","GXZZ","TLXR"];
...
function jumpSanCpyQueryDetail(businessKey,taskDefinitionKey,processInstanceId){
	...
	function successCallback(result) {
		...
		if(taskDefinitionKey == "GDCL"){
			...
			if(wcardStatus == 904030 && contractStatus == 8){
				var src = "/html/contReg/workOrderEdit/workOrderAssistFeasorEdit.html?pageType=2&taskFlag=db&taskDefinitionKey=TLXR&wcardId="+businessKey+"&processInstanceId="+processInstanceId;
